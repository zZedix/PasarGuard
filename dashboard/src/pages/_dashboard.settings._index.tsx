                ...
                <CardContent className="space-y-6">
                  <div className="flex items-center w-full justify-between">
                    <div className="space-y-2 flex-1">
                      <Label className="text-base" htmlFor="path">
                        Path
                      </Label>
                      <p className="text-sm text-muted-foreground">Control your server details</p>
                    </div>
              ...
              <Card className="flex-1 pt-6 w-full">
                ...
                <CardContent className="space-y-6">
                  <form onSubmit={telegramForm.handleSubmit(onTelegramSubmit)} className="space-y-4">
                    <div className="flex items-center w-full justify-between">
                      <div className="space-y-2 flex-1">
                        <Label className="text-base" htmlFor="telegram-token">
                          API Token
                        </Label>
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center w-full justify-between">
                      <div className="space-y-2 flex-1">
                        <Label className="text-base" htmlFor="telegram-webhook-url">
                          Webhook URL
                        </Label>
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center w-full justify-between">
                      <div className="space-y-2 flex-1">
                        <Label className="text-base" htmlFor="telegram-webhook-secret">
                          Webhook Secret
                        </Label>
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center w-full justify-between">
                      <div className="space-y-2 flex-1">
                        <Label className="text-base" htmlFor="telegram-proxy-url">
                          Proxy URL
                        </Label>
                      </div>
                      <div className="flex-1">
                    ...
                    <div>
                      ...
                      {webhooksFieldArray.fields.map((field, idx) => (
                        <div key={field.id} className="flex gap-2 mb-2">
                          ...
                          <Button type="button" variant="destructive" onClick={() => webhooksFieldArray.remove(idx)}>
                            -
                          </Button>
                        </div>
                      ))}
