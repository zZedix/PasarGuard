    ...
    <div className="flex flex-col gap-y-4">
      <div className={cn('flex flex-col lg:flex-row items-center justify-between gap-x-4 gap-y-4', dir === 'rtl' && 'lg:flex-row-reverse')}>
        ...
        <div className="w-full animate-fade-in" style={{ animationDuration: '600ms', animationDelay: '50ms' }}>
          <Card 
            dir={dir} 
            className="py-6 px-4 w-full rounded-md transition-all duration-500 overflow-hidden relative group"
          >
            <div className={cn(
            ...
            <CardTitle className="flex items-center justify-between gap-x-4 relative z-10">
              ...
              <span 
                className={cn(
                  "text-3xl mx-2 transition-all duration-500",
                  isIncreased.online_users ? "animate-zoom-out" : ""
                )}
          ...
          >
            ...
            <CardTitle className="flex items-center justify-between gap-x-4 relative z-10">
              ...
              <span 
                className={cn(
                  "text-3xl mx-2 transition-all duration-500",
                  isIncreased.active_users ? "animate-zoom-out" : ""
                )}
                style={{ animationDuration: '400ms' }}
              >
          ...
          >
            ...
            <CardTitle className="flex items-center justify-between gap-x-4 relative z-10">
              ...
              <span 
                className={cn(
                  "text-3xl mx-2 transition-all duration-500",
                  isIncreased.total_user ? "animate-zoom-out" : ""
                )}
                style={{ animationDuration: '400ms' }}
              >
