...
def upgrade() -> None:
    ...
    op.add_column('nodes', sa.Column('connection_type', sa.Enum('grpc', 'rest', name='nodeconnectiontype'), server_default='grpc', nullable=False))
    op.add_column('nodes', sa.Column('server_ca', sa.String(length=2048), nullable=False))
    op.add_column('nodes', sa.Column('keep_alive', sa.Integer(), nullable=False))
